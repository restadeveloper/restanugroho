  ...
  return (
    <div className="text-gray-700 font-sans">
      ...
      <section id="hero" className="w-full h-screen flex space-x-20 justify-center items-center p-16">
        ...
        <p className="font-jakarta">Halo Guys Saya Resta Nugroho Seorang Pelajar SMA | Fullstack Developer | Graphic Designer | Founder Yhoiki Team | Owner Community NWR | Motivation : "Bermimpilah setinggi langit dan jangan lupa bangun untuk mewujudkan, hiduplah untuk mencapai mimpi."</p>
      ...
      <section id="kedua" className="w-full h-screen flex flex-col justify-center items-center p-16">
        ...
        <p>Halo Guys Saya Resta Nugroho Seorang Pelajar SMA Lebih Tepatnya Madrasah Miftahul Huda Tayu | Fullstack Developer | Graphic Designer | Founder Yhoiki Team | Owner Community NWR | Motivation : "Bermimpilah setinggi langit dan jangan lupa bangun untuk mewujudkan, hiduplah untuk mencapai mimpi."</p>
        </div>
      </section>
